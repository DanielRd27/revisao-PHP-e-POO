...
function conectarBD() {
    ...
    // Retorna o objeto de conexão para ser utilizado nas operações de banco
    return $conexao;
}
        ...
        // -----------------------------------------------------------------
            ...
            if ($_POST["acao"] == "cadastrar") {
                ...
                if ($stmt->execute()) {
                    ...
                    // Redireciona para a mesma pagina para quando dar F5 nao reenviar os dados do formulario
                    header("Location: " . $_SERVER["PHP_SELF"]);
